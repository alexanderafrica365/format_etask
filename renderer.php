...
class format_etask_renderer extends format_section_renderer_base
{
        ...
        $completionExpected)
    {
        ...
        $progressChartCompleted = html_writer::tag('progress',
            null,
            [
                'class' => 'progress-chart-completed progress progress-striped progress-warning progress-animated',
        ...
        $progressChartPassed = html_writer::tag('progress',
            null,
            [
                'class' => 'progress-chart-passed progress progress-striped progress-success progress-animated',
        ...
        $progressCharts = html_writer::div(
            html_writer::div($progressChartCompleted, 'col-xs-12') .
            html_writer::div($progressChartPassed, 'col-xs-12'),
            'row'
        );
