...
$string['sectionavailability_title'] = 'Dostupnost tématu';
$string['sectiondelete_title'] = 'Smazat téma?';
$string['sectionmove_title'] = 'Přesunout téma';
$string['sectionname'] = 'Téma';
$string['sectionsavailability'] = 'Dostupnost témat';
$string['sectionsavailability_title'] = 'Dostupnost témat';
$string['sectionsdelete'] = 'Smazat témata';
$string['sectionsdelete_info'] = 'Tímto smažete {$a->count} témat a všechny aktivity, které obsahují.';
$string['sectionsdelete_title'] = 'Smazat vybraná témata?';
$string['sectionsmove'] = 'Přesouvat témata';
$string['sectionsmove_info'] = 'Přesunout {$a} témat za';
$string['sectionsmove_title'] = 'Přesunout vybraná témata';
$string['selectsection'] = 'Vyberte téma {$a}';
